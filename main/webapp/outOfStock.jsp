...
<%@ page import="medicineshop.GetConnection" %>
    ...
    <style>
        ...
        function removeMedicine(medicineName, element) {
            if (confirm('Are you sure you want to remove ' + medicineName + '?')) {
                ...
                xhr.open('GET', 'Removeoutofstock?name=' + encodeURIComponent(medicineName), true);
    ...
    <div class="container">
        ...
        <%
            try {
                ...
                ResultSet rs = stmt.executeQuery("SELECT name FROM outofstock");
        ...
        <%
                ...
                if (!hasData) {
        %>
        <p>No medicines are out of stock!</p>
        <%
                }
                con.close();
            } catch (Exception e) {
